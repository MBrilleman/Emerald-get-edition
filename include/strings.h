...
extern const u8 gText_MenuCasino[];
extern const u8 gText_MenuRoulette[];
...
extern const u8 gText_PlayerUsedRepel[];//reprompt_repel
...
extern const u8 CableClub_Text_TradeWithSelf[];
extern const u8 CableClub_Text_WonderTrade[];
