...
#define MULTI_GAME_CORNER_EVO_ITEMS_2      40 //Used by game corner for evolution items
#define MULTI_GAME_CORNER_EVO_ITEMS_1      41 //Used by game corner for evolution items
