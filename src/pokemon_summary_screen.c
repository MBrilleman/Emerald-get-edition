...
static void BufferStat(u8 *dst, s8 natureMod, u32 stat, u32 strId, u32 n); //colored_stats_for_natures
...
static void BufferLeftColumnStats(void)
{
    u8 *currentHPString = Alloc(20); //change colored_stats_for_natures
    u8 *maxHPString = Alloc(20); //change colored_stats_for_natures
    u8 *attackString = Alloc(20); //change colored_stats_for_natures
    u8 *defenseString = Alloc(20); //change colored_stats_for_natures
    const s8 *natureMod = gNatureStatTable[sMonSummaryScreen->summary.nature]; //colored_stats_for_natures
