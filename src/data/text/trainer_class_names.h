const u8 gTrainerClassNames[][13] = {
    [TRAINER_CLASS_YELLOW] = _("VETERAN"),
    [TRAINER_CLASS_CRYSTAL] = _("VETERAN"),
    ...
    [TRAINER_CLASS_PALACE_MAVEN] = _("BELLY MAN"), //Blisseys
    [TRAINER_CLASS_ARENA_TYCOON] = _("GETKWONDO"),
    [TRAINER_CLASS_FACTORY_HEAD] = _("CHOSEN ONE"), //Extra rival final form
    [TRAINER_CLASS_PIKE_QUEEN] = _("{PKMN} TRAINER"), //Extra rival
    [TRAINER_CLASS_PYRAMID_KING] = _("PYRAMID KING"), 
    [TRAINER_CLASS_RS_PROTAG] = _("{PKMN} TRAINER"),
    [TRAINER_CLASS_LEFTO] = _("LEFTO"),
    [TRAINER_CLASS_JOKE_MAN] = _("SPERRIE MAN"),
};
