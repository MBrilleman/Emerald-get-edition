...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .species = SPECIES_MIGHTYENA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CRUNCH, MOVE_SWAGGER, MOVE_POISON_FANG, MOVE_BODY_SLAM}
    },
    {
    .iv = 255,
    .lvl = 53,
    .species = SPECIES_SHARPEDO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CRUNCH, MOVE_SLASH, MOVE_HYDRO_PUMP, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 54,
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAMETHROWER, MOVE_CRUNCH, MOVE_OVERHEAT, MOVE_DOUBLE_EDGE}
    },
    {
    .iv = 255,
    .lvl = 54,
    .species = SPECIES_CACTURNE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_NEEDLE_ARM, MOVE_FAINT_ATTACK, MOVE_TEETER_DANCE, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 54,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FAINT_ATTACK, MOVE_AERIAL_ACE, MOVE_DOUBLE_EDGE, MOVE_PERISH_SONG}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .moves = {MOVE_ANCIENT_POWER, MOVE_CRUNCH, MOVE_EARTHQUAKE, MOVE_DRAGON_DANCE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_PSYCHIC, MOVE_PERISH_SONG}
    },
    {
    .iv = 255,
    .lvl = 54,
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_THUNDER_WAVE, MOVE_METRONOME, MOVE_DESTINY_BOND}
    },
    {
    .iv = 255,
    .lvl = 55,
    .species = SPECIES_SABLEYE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_FAINT_ATTACK, MOVE_FAKE_OUT, MOVE_RECOVER}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_SILVER_WIND, MOVE_TOXIC, MOVE_SECRET_POWER}
    },
    {
    .iv = 255,
    .lvl = 55,
    .species = SPECIES_GENGAR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FIRE_PUNCH, MOVE_THUNDERBOLT, MOVE_GIGA_DRAIN, MOVE_PSYCHIC}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SHADOW_PUNCH, MOVE_EARTHQUAKE, MOVE_CURSE, MOVE_FUTURE_SIGHT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FAKE_OUT, MOVE_AERIAL_ACE, MOVE_BRICK_BREAK, MOVE_QUICK_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 56,
    .species = SPECIES_JYNX,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_BEAM, MOVE_PSYCHIC, MOVE_WATER_PULSE, MOVE_CALM_MIND}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_BODY_SLAM, MOVE_THUNDERBOLT}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_ATTRACT, MOVE_ANCIENT_POWER, MOVE_BODY_SLAM}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_BEAM, MOVE_CRUNCH, MOVE_PROTECT, MOVE_EXPLOSION}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ICE_BEAM, MOVE_SURF, MOVE_BODY_SLAM, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_CLAW, MOVE_FLY, MOVE_EARTHQUAKE, MOVE_FLAMETHROWER}
    },
    {
    .iv = 255,
    .lvl = 57,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HEADBUTT, MOVE_EARTHQUAKE, MOVE_DOUBLE_EDGE, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 255,
    .lvl = 57,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_DOUBLE_EDGE}
    },
    {
    .iv = 255,
    .lvl = 57,
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_TOXIC, MOVE_SUBSTITUTE, MOVE_DRAGON_BREATH}
    },
    {
    .iv = 255,
    .lvl = 57,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OUTRAGE, MOVE_BRICK_BREAK, MOVE_WING_ATTACK, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 255,
    .lvl = 58,
    ...
    .moves = {MOVE_PSYCHIC, MOVE_DRAGON_CLAW, MOVE_THUNDERBOLT, MOVE_RECOVER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SCRATCH, MOVE_HARDEN, MOVE_ROCK_TOMB, MOVE_ROCK_SMASH}
    },
    {
    .iv = 100,
    .lvl = 15,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BULLET_SEED, MOVE_ASTONISH, MOVE_CONSTRICT, MOVE_ACID}
    },
    {
    .iv = 200,
    .lvl = 16,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .species = SPECIES_MACHOP,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_KARATE_CHOP, MOVE_FORESIGHT, MOVE_SEISMIC_TOSS, MOVE_BULK_UP}
    },
    {
    .iv = 100,
    .lvl = 22,
    ...
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STUN_SPORE, MOVE_MEGA_DRAIN, MOVE_MACH_PUNCH, MOVE_BULK_UP}
    },
    {
    .iv = 200,
    .lvl = 23,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUPERSONIC, MOVE_METAL_SOUND, MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE}
    },
    {
    .iv = 220,
    .lvl = 25,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_GUN, MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_SUPERSONIC}
    },
    {
    .iv = 250,
    .lvl = 26,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_QUICK_ATTACK, MOVE_HOWL, MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .species = SPECIES_KECLEON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SLASH, MOVE_SCREECH, MOVE_ROCK_TOMB, MOVE_ASTONISH}
    },
    {
    .iv = 200,
    .lvl = 31,
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_SLASH, MOVE_AERIAL_ACE, MOVE_SILVER_WIND}
    },
    {
    .iv = 210,
    .lvl = 35,
    .species = SPECIES_TROPIUS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM, MOVE_SYNTHESIS, MOVE_AERIAL_ACE}
    },
    {
    .iv = 210,
    .lvl = 36,
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_PULSE, MOVE_PROTECT, MOVE_RAIN_DANCE, MOVE_AERIAL_ACE}
    },
    {
    .iv = 220,
    .lvl = 36,
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STEEL_WING, MOVE_PURSUIT, MOVE_AGILITY, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 37,
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_DRAGON_DANCE, MOVE_DRAGON_BREATH, MOVE_AERIAL_ACE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_GRUMPIG,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_MAGIC_COAT, MOVE_CONFUSE_RAY, MOVE_SHOCK_WAVE}
    },
    {
    .iv = 200,
    .lvl = 41,
    .species = SPECIES_CHIMECHO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_SAFEGUARD, MOVE_DISABLE, MOVE_YAWN}
    },
    {
    .iv = 250,
    .lvl = 45,
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_HYPNOSIS, MOVE_CALM_MIND, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 250,
    .lvl = 45,
    .species = SPECIES_SOLROCK,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_SOLAR_BEAM, MOVE_SUNNY_DAY, MOVE_FLAMETHROWER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .species = SPECIES_WHISCASH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_RAIN_DANCE, MOVE_WATER_PULSE, MOVE_FUTURE_SIGHT}
    },
    {
    .iv = 250,
    .lvl = 49,
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FAKE_OUT, MOVE_GIGA_DRAIN, MOVE_BRICK_BREAK, MOVE_WATER_PULSE}
    },
    {
    .iv = 250,
    .lvl = 49,
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AERIAL_ACE, MOVE_CRABHAMMER, MOVE_SLUDGE_BOMB, MOVE_WATER_PULSE}
    },
    {
    .iv = 250,
    .lvl = 49,
    .species = SPECIES_RELICANTH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TAKE_DOWN, MOVE_YAWN, MOVE_ANCIENT_POWER, MOVE_WATER_PULSE}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .moves = {MOVE_ICE_BEAM, MOVE_REST, MOVE_DOUBLE_TEAM, MOVE_WATER_PULSE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GIGA_DRAIN, MOVE_HYDRO_PUMP, MOVE_ICE_PUNCH, MOVE_FIRE_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 59,
    .species = SPECIES_TENTACRUEL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_HYDRO_PUMP, MOVE_BARRIER, MOVE_MIRROR_COAT}
    },
    {
    .iv = 255,
    .lvl = 59,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_SURF, MOVE_ROCK_SLIDE, MOVE_COUNTER}
    },
    {
    .iv = 255,
    .lvl = 59,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_RECOVER, MOVE_SUBSTITUTE}
    },
    {
    .iv = 255,
    .lvl = 60,
    ...
    .moves = {MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_ANCIENT_POWER, MOVE_THUNDER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .lvl = 50,
    .species = SPECIES_ALTARIA,
    .moves = {MOVE_AERIAL_ACE, MOVE_EARTHQUAKE, MOVE_DRAGON_BREATH, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 150,
    .lvl = 50,
    .species = SPECIES_KECLEON,
    .moves = {MOVE_ANCIENT_POWER, MOVE_SLASH, MOVE_PSYBEAM, MOVE_SCREECH}
    },
    {
    .iv = 150,
    .lvl = 50,
    .species = SPECIES_ROSELIA,
    .moves = {MOVE_MAGICAL_LEAF, MOVE_PETAL_DANCE, MOVE_LEECH_SEED, MOVE_TOXIC}
    },
    {
    .iv = 150,
    .lvl = 50,
    .species = SPECIES_MAGNETON,
    .moves = {MOVE_SUPERSONIC, MOVE_THUNDERBOLT, MOVE_TRI_ATTACK, MOVE_REFLECT}
    },
    {
    .iv = 250,
    .lvl = 50,
    .species = SPECIES_FLYGON,
    .moves = {MOVE_EARTHQUAKE, MOVE_DRAGON_BREATH, MOVE_CRUNCH, MOVE_FLY}
    },
    {
    .iv = 250,
    .lvl = 51,
...
static const struct TrainerMonNoItemCustomMoves sParty_KimAndIris[] = {
    ...
    .lvl = 40,
    .species = SPECIES_ALTARIA,
    .moves = {MOVE_SING, MOVE_SUNNY_DAY, MOVE_DRAGON_BREATH, MOVE_AERIAL_ACE}
    },
    {
    .iv = 0,
    .lvl = 40,
...
static const struct TrainerMonItemCustomMoves sParty_Blissey4[] = {
    {
    .iv = 255,
    .lvl = 47,
...
static const struct TrainerMonItemCustomMoves sParty_Joke[] = {
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_SLUGMA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ENDURE, MOVE_HARDEN, MOVE_FLAMETHROWER, MOVE_AMNESIA}
    },
    {
    .iv = 255,
    .lvl = 35,
    .species = SPECIES_RHYDON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_STOMP, MOVE_HORN_ATTACK, MOVE_ENDURE, MOVE_ROCK_BLAST}
    },
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_GULPIN,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_YAWN, MOVE_STOCKPILE, MOVE_SWALLOW, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_AERIAL_ACE, MOVE_QUICK_ATTACK, MOVE_PROTECT, MOVE_SWALLOW}
    }
};

static const struct TrainerMonItemCustomMoves sParty_Getkwondo[] = {
    {
    .iv = 0,
    .lvl = 2,
...
static const struct TrainerMonItemCustomMoves sParty_Steven[] = {
    ...
    .heldItem = ITEM_SOUL_DEW,
    .moves = {MOVE_LUSTER_PURGE, MOVE_DRAGON_CLAW, MOVE_THUNDERBOLT, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 255,
    .lvl = 64,
    .species = SPECIES_ARMALDO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_AERIAL_ACE, MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE}
    },
    {
    .iv = 255,
    .lvl = 64,
    ...
    .species = SPECIES_AGGRON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_IRON_TAIL, MOVE_ROCK_SLIDE, MOVE_BRICK_BREAK, MOVE_BODY_SLAM}
    },
    {
    .iv = 255,
    .lvl = 64,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_OVERHEAT, MOVE_DOUBLE_EDGE, MOVE_SOLAR_BEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_eRival1_Mudkip[] = {
    {
    .iv = 0,
    .lvl = 2,
    .species = SPECIES_WHISMUR,
...
static const struct TrainerMonItemCustomMoves sParty_eRival1_Treecko[] = {
    {
    .iv = 0,
    .lvl = 2,
    .species = SPECIES_WHISMUR,
...
static const struct TrainerMonItemCustomMoves sParty_eRival1_Torchic[] = {
    {
    .iv = 0,
    .lvl = 2,
    .species = SPECIES_WHISMUR,
...
static const struct TrainerMonItemCustomMoves sParty_eRival2_Mudkip[] = {
    {
    .iv = 80,
    .lvl = 16,
    .species = SPECIES_ARON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_METAL_CLAW, MOVE_MUD_SLAP, MOVE_HARDEN, MOVE_HEADBUTT}   
    },
    {
    .iv = 80,
    .lvl = 18,
    ...
    .species = SPECIES_SABLEYE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LEER, MOVE_SCRATCH, MOVE_NIGHT_SHADE, MOVE_ASTONISH}
    },
    {
    .iv = 80,
    .lvl = 18,
    ...
    .moves = {MOVE_TACKLE, MOVE_BIDE, MOVE_MUD_SHOT, MOVE_WATER_GUN}
    }
};

static const struct TrainerMonItemCustomMoves sParty_eRival2_Treecko[] = {
    {
    .iv = 80,
    .lvl = 16,
    .species = SPECIES_ARON,
    ...
    .species = SPECIES_GROVYLE,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_QUICK_ATTACK, MOVE_ABSORB, MOVE_FURY_CUTTER, MOVE_PURSUIT}
    }
};

static const struct TrainerMonItemCustomMoves sParty_eRival2_Torchic[] = {
    {
    .iv = 80,
    .lvl = 16,
    .species = SPECIES_ARON,
    ...
    .species = SPECIES_COMBUSKEN,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_PECK, MOVE_DOUBLE_KICK, MOVE_EMBER, MOVE_FOCUS_ENERGY}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_eRival3_Mudkip[] = {
    {
    .iv = 160,
    .lvl = 32,
    .species = SPECIES_LAIRON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_METAL_CLAW, MOVE_ROAR, MOVE_IRON_DEFENSE, MOVE_HEADBUTT}   
    },
    {
    .iv = 160,
    .lvl = 33,
    .species = SPECIES_LOUDRED,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STOMP, MOVE_ASTONISH, MOVE_HOWL, MOVE_SWAGGER}
    },
    {
    .iv = 160,
    .lvl = 32,
    .species = SPECIES_SABLEYE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FAKE_OUT, MOVE_FAINT_ATTACK, MOVE_DETECT, MOVE_NIGHT_SHADE}
    },
    {
    .iv = 160,
    .lvl = 30,
    .species = SPECIES_SEVIPER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CRUNCH, MOVE_GLARE, MOVE_POISON_TAIL, MOVE_SCREECH}
    },
    {
    .iv = 160,
    .lvl = 33,
    .species = SPECIES_MARSHTOMP,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_TAKE_DOWN, MOVE_MUD_SHOT, MOVE_WATER_GUN, MOVE_MIRROR_COAT}
    }
};

static const struct TrainerMonItemCustomMoves sParty_eRival3_Treecko[] = {
    {
    .iv = 160,
    .lvl = 32,
    .species = SPECIES_LAIRON,
    ...
    .species = SPECIES_GROVYLE,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_LEAF_BLADE, MOVE_SCREECH, MOVE_PURSUIT, MOVE_QUICK_ATTACK}
    }
};

static const struct TrainerMonItemCustomMoves sParty_eRival3_Torchic[] = {
    {
    .iv = 160,
    .lvl = 32,
    .species = SPECIES_LAIRON,
    ...
    .species = SPECIES_COMBUSKEN,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_DOUBLE_KICK, MOVE_ROCK_SLIDE, MOVE_EMBER, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_eRival4_Mudkip[] = {
    ...
    .species = SPECIES_SABLEYE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FAKE_OUT, MOVE_SHADOW_BALL, MOVE_DETECT, MOVE_FAINT_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 46,
    ...
    .moves = {MOVE_SURF, MOVE_PROTECT, MOVE_EARTHQUAKE, MOVE_ICE_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 50,
...
static const struct TrainerMonItemCustomMoves sParty_eRival4_Treecko[] = {
    {
    .iv = 255,
    .lvl = 47,
    .species = SPECIES_SABLEYE,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_LEAF_BLADE, MOVE_DRAGON_BREATH, MOVE_CRUNCH, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 50,
...
static const struct TrainerMonItemCustomMoves sParty_eRival4_Torchic[] = {
    {
    .iv = 255,
    .lvl = 47,
    .species = SPECIES_SABLEYE,
...
static const struct TrainerMonItemCustomMoves sParty_Yellow[] = {
    ...
    .species = SPECIES_HYPNO,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_BRICK_BREAK, MOVE_PSYCHIC, MOVE_FIRE_PUNCH, MOVE_REFLECT}
    },
    {
    .iv = 255,
    .lvl = 70,
    .species = SPECIES_LAPRAS,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_ICE_BEAM, MOVE_SLEEP_TALK, MOVE_REST}
    },
    {
    .iv = 255,
    .lvl = 70,
    ...
    .moves = {MOVE_THUNDER_WAVE, MOVE_THUNDERBOLT, MOVE_DRILL_PECK, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 255,
    .lvl = 70,
    ...
    .moves = {MOVE_EXPLOSION, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_FOCUS_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 70,
    ...
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_DRAGON_DANCE, MOVE_ANCIENT_POWER, MOVE_SUBSTITUTE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_CrystalMaarten[] = {
    ...
    .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_IRON_TAIL, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 75,
    .species = SPECIES_POLITOED,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_TOXIC, MOVE_PROTECT, MOVE_HYDRO_PUMP, MOVE_SUBSTITUTE}
    },
    {
    .iv = 255,
    .lvl = 75,
    ...
    .moves = {MOVE_DRAGON_DANCE, MOVE_ANCIENT_POWER, MOVE_EARTHQUAKE, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 75,
    ...
    .moves = {MOVE_SLUDGE_BOMB, MOVE_SHADOW_BALL, MOVE_EARTHQUAKE, MOVE_THUNDERBOLT}
    },
    {
    .iv = 255,
    .lvl = 75,
    .species = SPECIES_MAGCARGO,
    .heldItem = ITEM_BRIGHT_POWDER,
    .moves = {MOVE_OVERHEAT, MOVE_AMNESIA, MOVE_YAWN, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 75,
    ...
    .moves = {MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE, MOVE_HYPER_BEAM, MOVE_REST}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_CrystalMarcus[] = {
    ...
    .species = SPECIES_MUK,
    .heldItem = ITEM_SALAC_BERRY,
    .moves = {MOVE_EXPLOSION, MOVE_SLUDGE_BOMB, MOVE_SCREECH, MOVE_BRICK_BREAK}
    },
    {
    .iv = 255,
    .lvl = 75,
    ...
    .heldItem = ITEM_BRIGHT_POWDER,
    .moves = {MOVE_THUNDER_WAVE, MOVE_SWAGGER, MOVE_MEAN_LOOK, MOVE_PERISH_SONG}
    },
    {
    .iv = 255,
    .lvl = 75,
...
static const struct TrainerMonItemCustomMoves sParty_CrystalRob[] = {
    ...
    .moves = {MOVE_TOXIC, MOVE_DOUBLE_TEAM, MOVE_CONFUSE_RAY, MOVE_SURF}
    }
};
