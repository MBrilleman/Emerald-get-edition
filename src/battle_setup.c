...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_BRAWLY] = REMATCH(TRAINER_BRAWLY_1, TRAINER_BRAWLY_1, TRAINER_BRAWLY_1, TRAINER_BRAWLY_1, TRAINER_BRAWLY_1, MAP_DEWFORD_TOWN),
    [REMATCH_WATTSON] = REMATCH(TRAINER_WATTSON_1, TRAINER_WATTSON_1, TRAINER_WATTSON_1, TRAINER_WATTSON_1, TRAINER_WATTSON_1, MAP_MAUVILLE_CITY),
    [REMATCH_FLANNERY] = REMATCH(TRAINER_FLANNERY_1, TRAINER_FLANNERY_1, TRAINER_FLANNERY_1, TRAINER_FLANNERY_1, TRAINER_FLANNERY_1, MAP_LAVARIDGE_TOWN),
    [REMATCH_NORMAN] = REMATCH(TRAINER_NORMAN_1, TRAINER_NORMAN_1, TRAINER_NORMAN_1, TRAINER_NORMAN_1, TRAINER_NORMAN_1, MAP_PETALBURG_CITY),
    [REMATCH_WINONA] = REMATCH(TRAINER_WINONA_1, TRAINER_WINONA_1, TRAINER_WINONA_1, TRAINER_WINONA_1, TRAINER_WINONA_1, MAP_FORTREE_CITY),
    [REMATCH_TATE_AND_LIZA] = REMATCH(TRAINER_TATE_AND_LIZA_1, TRAINER_TATE_AND_LIZA_1, TRAINER_TATE_AND_LIZA_1, TRAINER_TATE_AND_LIZA_1, TRAINER_TATE_AND_LIZA_1, MAP_MOSSDEEP_CITY),
    [REMATCH_JUAN] = REMATCH(TRAINER_JUAN_1, TRAINER_JUAN_1, TRAINER_JUAN_1, TRAINER_JUAN_1, TRAINER_JUAN_1, MAP_SOOTOPOLIS_CITY),
